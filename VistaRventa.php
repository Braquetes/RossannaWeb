  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-8 pt-5">
        <h5 class="Title3">Historial de ventas</h5>
      </div>
      <div class="col-lg-3">
        <div class="media white z-depth-1 rounded">
          ...
          <div class="media-body p-1">
            ...
            // Muestra el total de ganancias de las fechas que fueron seleccionadas
      ...
      <div class="col-lg-12">
        <table id="example" class="table table-bordered  display nowrap" cellspacing="0" width="100%">
          ...
          <tbody>
            ...
            $fecha2 = $_POST["Fin"];
            require("./BaseDatos/Conexion.php"); //Muestra el historial de los productos en venta por cada uno
            //Muestra las ventas que se hicieron en esa temporada
            $muestraventas = mysqli_query($conexion, "SELECT SUM(Cantidad) AS Cantidad, ROUND(SUM(Precio*Cantidad),2) as Total, Fecha from inventario_estadistica where Fecha >='".$fecha1."' and Fecha <= '".$fecha2."' GROUP by Fecha");
            if ($muestraventas->num_rows > 0) {
              while ($row = mysqli_fetch_array($muestraventas)) {
            ?>
                <tr class="tr">
